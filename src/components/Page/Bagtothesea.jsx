...
function Bagtothesea() {
  // Products array for 4 columns x 3 rows (12 products)
  const products = [
    {
      brand: 'SeaBreeze',
      ...
      price: '39.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea1.jpg',
    },
    {
      brand: 'CoastalChic',
      ...
      typicalPrice: '54.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea2.jpg',
    },
    {
      brand: 'SeaBreeze',
      ...
      price: '59.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea3.webp',
    },
    {
      brand: 'OceanVibes',
      ...
      listPrice: '29.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea4.jpg',
    },
    {
      brand: 'NauticalNest',
      ...
      price: '44.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea5.jpg',
    },
    {
      brand: 'SeaBreeze',
      ...
      typicalPrice: '59.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea6.jpg',
    },
    {
      brand: 'CoastalChic',
      ...
      price: '34.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea7.jpg',
    },
    {
      brand: 'OceanVibes',
      ...
      listPrice: '34.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea8.webp',
    },
    {
      brand: 'NauticalNest',
      ...
      price: '49.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea9.webp',
    },
    {
      brand: 'SeaBreeze',
      ...
      price: '27.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea10.webp',
    },
    {
      brand: 'CoastalChic',
      ...
      typicalPrice: '57.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea11.jpg',
    },
    {
      brand: 'OceanVibes',
      ...
      listPrice: '42.99',
      delivery: 'Mon, Sep 29',
      imageSrc: '/src/components/img/Bag to the Sea12.jpg',
    },
  ];
