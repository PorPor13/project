...
const products = [
  {
    ...
    oldPrice: 45,
    rating: 4.5,
    image: "/src/components/img/Handbag.jpg",
  },
  {
    id: 2,
    name: "School Bag",
    ...
    oldPrice: null,
    rating: 4.5,
    image: "/src/components/img/School Bag.webp",
  },
  {
    id: 3,
    name: "Bag to the Sea",
    ...
    oldPrice: null,
    rating: 4.0,
    image: "/src/components/img/Bag to the Sea.webp",
  },
  {
    id: 4,
    name: "Work Bag",
    ...
    oldPrice: null,
    rating: 5.0,
    image: "/src/components/img/Work Bag.webp",
  },
  {
    id: 5,
    name: "Local Bag",
    ...
    oldPrice: null,
    rating: 3.5,
    image: "/src/components/img/Local Bag.jpg",
  },
  {
    id: 6,
    name: "Event Bag",
    ...
    oldPrice: 90,
    rating: 4.0,
    image: "/src/components/img/Event Bag.webp",
  },
  {
    id: 7,
    name: "Hiking Bag",
    ...
    oldPrice: null,
    rating: 5.0,
    image: "/src/components/img/Hiking Bag.jpg",
  },
];
  ...
  return (
    <div className={`font-sans ${darkMode ? 'dark bg-gradient-to-r from-orange-200 via-pink-200 to-purple-200' : 'bg-fuchsia-100'} min-h-screen`}>
      ...
      <main className="max-w-screen-xl mx-auto p-6">
        <h1 className="text-5xl text-center text-blue-700 mb-8 font-bold dark:text-blue-300">Women's Collection</h1>
        <Outlet />
        ...
        <section className="container mx-auto px-4 md:px-8 py-12 lg:flex lg:gap-12">
          ...
          <section className="lg:w-3/4">
            <div className="flex flex-col md:flex-row items-center justify-between mb-8">
              <h2 className="font-bold text-3xl mb-4 md:mb-0 text-gray-900 dark:text-gray-200">Women's Bags</h2>
        ...
        <section className="bg-white py-6 border-b border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
          <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-10 px-4">
            <NavLink
              ...
              aria-label="Go to Track Your Order page"
            >
              Track Your Order
            </NavLink>
            <NavLink
